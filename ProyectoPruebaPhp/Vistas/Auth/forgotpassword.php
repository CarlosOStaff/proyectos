...
<body>
    <div class="container">
        <div class="row justify-content-center align-items-center vh-100">
            <div class="card col-md-6 col-lg-6 shadow-lg">
                <div class="p-4">
                    <div class="card-body">
                        <h4 class="card-title mb-4 text-center">Recuperar Contraseña</h4>
                        <p class="txt text-center mb-4">Introduce tu correo electrónico para recibir instrucciones sobre cómo recuperar tu contraseña.</p>
                        <form action="../../Auth/forgotpassword.php" method="POST">
                            <div class="mb-3">
                                <label for="emailInput" class="txt form-label">Correo Electrónico</label>
                        ...
                        <div class="backlogin text-center mt-3">
