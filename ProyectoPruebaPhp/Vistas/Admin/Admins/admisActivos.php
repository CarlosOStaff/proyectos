...
<head>
    ...
    <link rel="stylesheet" href="../../../Css/cssAdmin/adminactivos.css">
</head>
    ...
    <div class="container">
        ...
        <div class="row mx-auto justify-content-center align-items-stretch">
            <?php while ($row = $result->fetch_assoc()): ?>
                <div class="col-xl-3 col-sm-6 shadow-lg p-4 mb-5 mx-4 rounded-5">
                    <div class="h-100 text-center">
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <h5 class="txt-title mb-1 fst-italic"><a class="text-dark"><?php echo $row['nombre'] ?></a></h5>
                            <p class="txt text-muted fw-bold d-inline-block text-truncate"><?php echo $row['apellido'] ?></p>
                            <p class="txt text-muted fw-bold  d-inline-block text-truncate"><?php echo $row['email'] ?></p>
