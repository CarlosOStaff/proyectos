                        ...
                        echo '<li class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle text-white fw-bold" id="navbarDropdown" role="button"
                                ...
                                <img src="../../Recursos/img/users/perfil/' . ($user['img_perfil']) . '"
                                    class="mh-25 mw-25 h-25 w-25 mx-1 px-3 rounded-circle" id="profileImage">' . htmlspecialchars($user['nombre']) . '
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="../Admin/perfil.php">Mi cuenta</a></li>
                            </ul>
                        </li>';
                    } else {
