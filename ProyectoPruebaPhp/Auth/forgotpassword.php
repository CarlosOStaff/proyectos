...
if ($result->num_rows > 0) {
    ...
    <a href="http://proyectos.test/ProyectoPruebaPhp/Vistas/Auth/cambiarpassword.php?email='.$email.'&token='.$password_reset_token.'" style="display: inline-block; padding: 1vw 1.5vw; background-color: #007bff; color: #fff; text-decoration: none; border-radius: 5px;">Cambiar contraseña</a>
</div>';
        $mail->send();
